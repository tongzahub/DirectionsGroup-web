...
export interface ApiAboutSectionAboutSection
  extends Struct.CollectionTypeSchema {
  collectionName: 'about_sections';
  info: {
    description: 'Sections for the About page with submenu navigation';
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog posts with categories, tags, and scheduling';
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['News', 'Case Study', 'Thought Leadership']
    > &
      Schema.Attribute.Required;
    content: Schema.Attribute.RichText & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Client case studies with structured sections and gallery';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    execution: Schema.Attribute.RichText & Schema.Attribute.Required;
    featuredImage: Schema.Attribute.Media<'images'>;
    ...
    slug: Schema.Attribute.UID<'title'> &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    strategy: Schema.Attribute.RichText & Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiContactInquiryContactInquiry
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['New', 'Read', 'Responded']> &
      Schema.Attribute.Required &
...
export interface ApiIndustryIndustry extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Industries served by the agency';
...
export interface ApiJobListingJobListing extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Career opportunities and job postings';
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Static pages with SEO fields';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site configuration and content';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cultureStatement: Schema.Attribute.RichText;
    homepageIntro: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    siteName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'The Bureau of Wonders'>;
